			...
			<div class="container-fluid">
                ...
                <a class="nav-link" href="guideline.html">規格書</a>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="user_login.jsp">登入</a> <!--active是調整成高亮
                --></li>
	...
	<div class="wrapper">
		<aside id="aside_style">
			...
			<div class="user_image">
				<center>
					<img src="ShowImage?user_ID=${uservo.user_ID}" width="145"
		...
		<div id="contents" class="container p-4">
			...
			<form enctype="multipart/form-data" action="AdminUser" method="post"
				name="update-form">
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserID"
							value="${uservo.user_ID}" name="user_ID" readonly>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserEmail"
							value="${uservo.user_email}" name="UserEmail">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserPwd"
							value="${uservo.user_pwd}" name="UserPwd">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserName"
							value="${uservo.user_name}" name="user_name">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserNickname"
							value="${uservo.user_nickname}" name="user_nickname">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserMobile"
							value="${uservo.user_tel}" name="user_tel">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="UserVip"
							value="${uservo.user_vip_level_id}" name="UserVip">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="Userdatetime"
							value="${uservo.user_datetime}" name="Userdatetime" readonly>
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<div class="form-group col-sm-8">
					...
					<div class="input-group">
						<input type="text" class="form-control" id="Userstatus"
							value="${uservo.user_status}" name="Userstatus">
						<button class="btn btn-primary">
							<i class="fa-regular fa-pen-to-square">編輯</i>
						</button>
					</div>
				...
				<br> <input type="hidden" name="action"
					value="admin_UserUpdate"> <input type="hidden" id="UserId"
					name="user_ID" value=${uservo.user_ID}>
